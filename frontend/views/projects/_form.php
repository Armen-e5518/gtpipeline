...
<div class="projects-form" id="id_project_forms">
   ...
   <div class="row">
      <div class="col-md-6">
         ...
         <?= $form->field($model, 'service_line')->dropDownList(\frontend\components\DropdownData::service_line(), ['prompt' => 'Select services to be provided from the dropdown']) ?>
         <?= $form->field($model, 'project_components')->dropDownList(\frontend\components\DropdownData::project_components(), ['prompt' => 'Select components engaged in the project from the list ']) ?>
         ...
         <?= $form->field($model, 'international_status')->checkbox([]); ?>
      </div>
      <div class="col-md-6">
         ...
         <div>
            <label class="control-label">Restriction by user groups</label>
            <div class="add-countries">
               <?= \kartik\select2\Select2::widget([
                  'name' => 'groups',
                  'value' => $select_groups,
   ...
   <?php if (!empty($update) && $model->status > 1 || 1): ?>
      <div class="row">
         <div class="col-md-6">
            <hr>
            <h1>Step 1</h1>
            <?= $form->field($model, 'name_firm')->dropDownList(\frontend\components\DropdownData::name_firm(), ['prompt' => 'Select from the dropdown']) ?>
         ...
         <?php if (!empty($update) && $model->status > 2 || 1): ?>
            <div class="col-md-6">
               <hr>
               <h1>Step 2</h1>
               ...
               <?= $form->field($model, 'actual_services_description')->textInput(['maxlength' => true, 'title' => $model->getAttributeLabel('actual_services_description'), 'placeholder' => 'Describe provided services']) ?>
            </div>
         <?php endif; ?>
      </div>
   <?php endif; ?>
