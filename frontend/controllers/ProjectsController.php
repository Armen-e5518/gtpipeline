...
// Saving the document as OOXML file...
   ...
   public function actionView($id)
   {
      ...
      $name_firm = $project['name_firm'] ? \frontend\components\DropdownData::name_firm()[$project['name_firm']] : '';
      $table->addRow();
      ...
      $table->addRow();
      $table->addCell(10000, $cellColSpan)->addText("Name of Firm: {$name_firm}");
