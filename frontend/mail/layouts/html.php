                        ...
                        <tr>
                           <td valign="top" class="mcnTextBlockInner">
                              ...
                              <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%;min-width:100%;" width="100%"
                                 ...
                                 <tbody>
                                 <tr>
                                    <td valign="top" class="mcnTextContent mcnTextContent-padding "
                                        style="padding:67px 37px 80px;color:#3e3c41;font-size:20px;font-weight:400; line-height:100%; font-family:Arial, serif;">
                                       <?= $content ?>
                                       <br>
                                       <br>
                                       <br>
                                 ...
                                 <tr>
                                    <td valign="top" class="mcnTextContent" style="padding:0px 37px 25px;">
                                       <a href="http://www.grantthornton.am/" target="_blank">
                                          <img class="logo-mobile" style="max-width: 100%;"
                                               src="https://gallery.mailchimp.com/af7c553c367b64dbbc54ef2f0/images/b5442bcf-856a-4a28-b79d-729cd1b6bcfc.png">
                                       </a>
                                    </td>
                                 </tr>
                                 </tbody>
